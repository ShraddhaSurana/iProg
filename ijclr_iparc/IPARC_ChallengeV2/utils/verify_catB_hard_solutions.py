...
def verify_solution(tasks, list_ops):
    """
    Verify the solution for CatB_Hard tasks.
...
if __name__ == '__main__':
    ...
    if read_all_solutions_from_file:
        count = 0
        # Load CSV
        csv_file = "../solutions/task_results_catB_hard.csv"
        ...
        for _, row in df.iterrows():
            ...
            # Load the dataset
            catB_iteration = f"../Dataset/CatB_Hard/{task_filename}"
        ...
        task_index = 24
        list_ops = [[None, 1, 'Hit-Or-Miss', 'SE2'], [1, 3, 'Dilation', 'SE1'], [1, 3, 'Erosion', 'SE1'], [2, 1, 'Dilation', 'SE1'], [2, 1, 'Dilation', 'SE2'], [2, 1, 'Dilation', 'SE5'], [2, 1, 'Dilation', 'SE1'], [2, 1, 'Erosion', 'SE1'], [2, 1, 'Erosion', 'SE1'], [2, 1, 'Erosion', 'SE5'], [None, 1, 'change_color', [[0, 0, 0], [0, 1, 2], [1, 0, 1], [1, 1, 2]]]]

        print(f"Task: {task_index}")
        with open("../Dataset/CatB_Hard/Task{:03d}.json".format(task_index), 'r') as f:
            tasks = json.load(f)
